  ...
  switch (action.type) {
    ...
    case "SET_EMPLOYERS_AFTER_EDIT":
      ...
      return {
        ...
        filteredEmployers: [...employersAfterEdit],
        employerEdited: null,
      };
    case "TOGGLE_POPUP":
    ...
    case "REMOVE_EMPLOYER":
      ...
      console.log(employersAfterRemoving.length);
      return {
        ...state,
        employers: [...employersAfterRemoving],
        filteredEmployers: [...employersAfterRemoving],
        activeEmp:0
          // employersAfterRemoving.length === 0
          //   ? 0
          //   : state.activeEmp >= employersAfterRemoving.length
          //   ? employersAfterRemoving.length - 2
          //   : state.activeEmp,
      };
    ...
    case "SET_ACTIVE_EMP":
      return { ...state, activeEmp: action.payload };
    default:
      return state;
  }
};
